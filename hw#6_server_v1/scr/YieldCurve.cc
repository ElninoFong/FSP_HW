...
double YieldCurve::cal_2yr_dv01() {
    double rate_2yr = cal_yield_rate(2);
    Coupon_bearing_calculator *bearing = new Coupon_bearing_calculator(2, rate_2yr, rate_2yr, 4);
    return bearing->cal_bond_dv01();
}
